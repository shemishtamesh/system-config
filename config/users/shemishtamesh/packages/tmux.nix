  ...
  programs.tmux = {
    ...
    extraConfig =
      ...
      ''
        ...
        bind-key "C-c" display-popup -E 'echo "repository to clone:" && ${sesh} clone --cmdDir "$HOME/projects" $(head -n 1)'
        bind-key "M-c" display-popup -E 'echo "repository to clone:" && ${sesh} clone --cmdDir "$HOME/tests" $(head -n 1)'
