  ...
  programs.tmux = {
    ...
    extraConfig =
      ...
      ''
        ...
        set -g window-status-format '#{?#{==:#I,#{base-index}},#[bg=${base01}]#[fg=${base0D}]#[bold]#S#[fg=${base03}]#[nobold] |,#[bg=${base01}]} #I:#W#F'
        set -g window-status-current-format '#{?#{==:#I,#{base-index}},#[bg=${base01}]#[fg=${base0D}]#[bold]#S#[fg=${base03}]#[nobold] |,#[bg=${base01}]} #[fg=${base0D}]#I:#W#F'
