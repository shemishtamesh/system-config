  ...
  programs.tmux = {
    ...
    extraConfig =
      ...
      ''
        ...
        set -g window-status-format '#{?#{==:#I,#{base-index}},#[default],#[fg=${base0D}]#[bold]#S#[fg=${base03}]#[nobold] |} #I:#W#F'
        set -g window-status-current-format '#{?#{==:#I,#{base-index}},#[default],#[fg=${base0D}]#[bold]#S#[fg=${base03}]#[nobold] |} #[fg=${base0D}]#I:#W#F#[default]'
