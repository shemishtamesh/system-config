    ...
    in
    {
      ...
      settings = {
        ...
        bind = [
          ...
          "$mod, s, exec, hyprshot --freeze --mode active -- ${pkgs.swappy}"
          "$mod SHIFT, s, exec, hyprshot --freeze --mode region -- ${pkgs.swappy}"
          "$mod CTRL, s, exec, hyprshot --freeze --mode window -- ${pkgs.swappy}"
          "$mod ALT, s, exec, hyprshot --freeze --mode output -- ${pkgs.swappy}"
