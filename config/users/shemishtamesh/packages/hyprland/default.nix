    ...
    in
    {
      ...
      settings = {
        ...
        bind = [
          ...
          "$mod, s, exec, hyprshot --freeze --mode active"
          "$mod SHIFT, s, exec, hyprshot --freeze --mode region"
          "$mod CTRL, s, exec, hyprshot --freeze --mode window"
          "$mod ALT, s, exec, hyprshot --freeze --mode output"
