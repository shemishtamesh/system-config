  ...
  programs.nixvim = {
    ...
    plugins.treesitter-textobjects.extraOptions.move =
      let
        ...
        textobjectsMoveKey = isNext: isStart: key: "${if isNext then "]" else "["}${if isStart then key else lib.toUpper key}";
    ...
    plugins.treesitter-textobjects.extraOptions.select.keymaps = {
      ...
      "ia" = { query = "@assignment.inner"; query_group = "locals"; desc = "Select inner part of a assignment region"; };
      "aa" = { query = "@assignment.outer"; query_group = "locals"; desc = "Select outer part of an assignment region"; };
      "il" = { query = "@loop.inner"; query_group = "locals"; desc = "Select inner part of a loop region"; };
      "al" = { query = "@loop.outer"; query_group = "locals"; desc = "Select outer part of a loop region"; };
      "ii" = { query = "@conditional.inner"; query_group = "locals"; desc = "Select inner part of a conditional region"; };
      "ai" = { query = "@conditional.outer"; query_group = "locals"; desc = "Select outer part of a conditional region"; };
      "ik" = { query = "@block.inner"; query_group = "locals"; desc = "Select inner part of a block region"; };
